...
namespace Attendance_Management_System.Migrations
{
    ...
    [Migration("20240420171959_making column for profile picture")]
    partial class makingcolumnforprofilepicture
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Attendance_Management_System.Models.Permission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BodyOfDescription = "1",
                            DateCreated = new DateTime(2024, 4, 20, 19, 19, 53, 894, DateTimeKind.Local).AddTicks(2184),
                            ID = 1,
                            Reason = "1",
                            Status = 0
                        },
                        new
                        {
                            ...
                            Date = new DateOnly(2024, 4, 20),
                            BodyOfDescription = "2",
                            DateCreated = new DateTime(2024, 4, 20, 19, 19, 53, 894, DateTimeKind.Local).AddTicks(2421),
                            ID = 2,
                            Reason = "2",
                            Status = 0
                        },
                        new
                        {
                            ...
                            Date = new DateOnly(2024, 4, 20),
                            BodyOfDescription = "3",
                            DateCreated = new DateTime(2024, 4, 20, 19, 19, 53, 894, DateTimeKind.Local).AddTicks(2427),
                            ID = 3,
                            Reason = "3",
                            Status = 0
                        },
                        new
                        {
                            ...
                            Date = new DateOnly(2024, 4, 20),
                            BodyOfDescription = "4",
                            DateCreated = new DateTime(2024, 4, 20, 19, 19, 53, 894, DateTimeKind.Local).AddTicks(2432),
                            ID = 4,
                            Reason = "4",
                            Status = 0
                        },
                        new
                        {
                            ...
                            Date = new DateOnly(2024, 4, 20),
                            BodyOfDescription = "5",
                            DateCreated = new DateTime(2024, 4, 20, 19, 19, 53, 894, DateTimeKind.Local).AddTicks(2437),
                            ID = 5,
                            Reason = "5",
                            Status = 0
                        });
